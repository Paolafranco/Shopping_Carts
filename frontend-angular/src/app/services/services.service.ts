...
export class ServicesService {
  ...
  //Articles example buscador
  readArticles(query = '') {
    return this.httpClient.get('http://127.0.0.1:8000/api/articles', { params: { buscarArticle: query } });
  }
  ...
  //search
  searchArticule(query = '') {
    return this.httpClient.get('http://127.0.0.1:8000/api/searchArticule/', { params: { name: query } })
  }
  //articules
  getProductsDataJoin() {
